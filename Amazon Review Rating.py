from bs4 import BeautifulSoup as bs#extracting the data
from selenium import webdriver#website access
import pandas as pd
...
for j in range(1,5):
    ...
    cont=bs(content)
    for i in cont.find_all('div',attrs={'class':'sg-col sg-col-4-of-12 sg-col-8-of-16 sg-col-12-of-20 s-list-col-right'}):
        authoryear=i.find('div',attrs={'class':'a-size-base a-color-secondary a-text-normal'})
        rating=i.find('div',attrs={'class':'class="a-row a-size-small"'})
